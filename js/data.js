...
const ST = {
  ...
  rage:{id:'rage', name:'狂躁', kind:'buff', turns:6, desc:'攻击力+80%、速度+60，每回合额外攻击1次，掌掴改为攻击周围8格。持续6回合。'},
