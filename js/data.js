...
const ENEMIES = {
  slime:{ name:'草史莱姆', icon:'🟢', tier:'ordinary', atk:10, def:0, maxHp:100, speed:4,
    ...
    passives:[ SLIME_TEMPLATE.forwards12, {id:'affin_grass', name:'草元素亲和', desc:'免疫草元素伤害。自身地块总是附着草元素。'} ],
  ...
  fireSlime:{ name:'火史莱姆', icon:'🔴', tier:'ordinary', atk:10, def:0, maxHp:100, speed:4,
    res:{physical:0,fire:0,water:0,grass:0,thunder:0,ice:0,wind:0,rock:0}, healthPenalty:1, reward:{items:{fruit:2}},
    passives:[ SLIME_TEMPLATE.forwards12, {id:'affin_fire', name:'火元素亲和', desc:'免疫火元素伤害。自身地块总是附着火元素。'} ],
  ...
  waterSlime:{ name:'水史莱姆', icon:'🔵', tier:'ordinary', atk:10, def:0, maxHp:100, speed:4,
    res:{physical:0,fire:0,water:0,grass:0,thunder:0,ice:0,wind:0,rock:0}, healthPenalty:1, reward:{items:{fruit:2}},
    passives:[ SLIME_TEMPLATE.forwards12, {id:'affin_water', name:'水元素亲和', desc:'免疫水元素伤害。自身地块总是附着水元素。'} ],
  ...
  thunderSlime:{ name:'雷史莱姆', icon:'🟣', tier:'ordinary', atk:10, def:0, maxHp:100, speed:4,
    res:{physical:0,fire:0,water:0,grass:0,thunder:0,ice:0,wind:0,rock:0}, healthPenalty:1, reward:{items:{fruit:2}},
    passives:[ SLIME_TEMPLATE.forwards12, {id:'affin_thunder', name:'雷元素亲和', desc:'免疫雷元素伤害。自身地块总是附着雷元素。'}, {id:'conduct', name:'导电', desc:'每回合结束时，有10%概率对周围8格造成不分敌我的40%攻击力雷伤。'} ],
    skills:[ SLIME_TEMPLATE.jp, SLIME_TEMPLATE.bang ] },
  iceSlime:{ name:'冰史莱姆', icon:'🩵', tier:'ordinary', atk:10, def:0, maxHp:100, speed:4,
    res:{physical:0,fire:0,water:0,grass:0,thunder:0,ice:0,wind:0,rock:0}, healthPenalty:1, reward:{items:{fruit:2}},
    passives:[ SLIME_TEMPLATE.forwards12, {id:'affin_ice', name:'冰元素亲和', desc:'免疫冰元素伤害。自身地块总是附着冰元素。'} ],
