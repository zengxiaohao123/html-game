...
const ENEMIES = {
  ...
  ironClump:{ name:'铁疙瘩', icon:'🔩', tier:'ordinary', atk:18, def:8, maxHp:200, speed:2, res:{physical:30,fire:50,water:0,grass:0,thunder:20,ice:0,wind:0,rock:20}, healthPenalty:1, reward:{items:{iron:2}, rate:{diamond:1, prob:0.1}, attrUp:2}, passives:[ {id:'sturdy', name:'结实', desc:'物理伤害减免30%、岩元素伤害减免20%；对火元素抗性-50%（受到火伤+50%）。'} ], skills:[ {id:'icjp', name:'缓慢逼近', kind:'move', desc:'向着主角，移动1格。'}, {id:'icSlam', name:'铁疙瘩重砸', kind:'attack', type:'physical', target:'adj-rand', mult:1.0, desc:'对周围8格随机1名我方单位造成100%攻击力物理伤害，30%概率施加【束缚】1回合。'} ] },
};
