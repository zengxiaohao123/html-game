...
const TASKS = [
  { id:'m1', cat:'main', name:'第一幕·分道扬镳', goals:['存活下去，保证自己的健康大于 0','探索野外，推进剧情'], last:null, rewards:[{key:'caiyunPendant', text:'裁云挂件'}] },
  { id:'s1', cat:'side', name:'讨伐任务·暴躁的熊', goals:['击败1头暴躁的熊'], last:1, hook:'bearQuestStarted', rewards:[{simple:'金币+5'},{simple:'主角防御力+10'}] },
  { id:'s2', cat:'side', name:'日常任务·日行一善', goals:['累计扶起摔倒的老奶奶10次'], last:10, rewards:[{key:'goodCard', text:'好人卡'}] },
  /* === 新启程任务 === */
  { id:'qMental', cat:'side', name:'启程任务·心理健康', goals:['保持心理压力在20及以下，连续30天'], last:30, desc:'心理健康是很重要的噢。如果压力太大，容易陷入【抑郁】状态。', rewards:[{simple:'金币+10'}],
    auto:true, trackField:'mentalGoodDays', onDayHook:true, breakOnHighStress:true },
  { id:'qCraft',  cat:'side', name:'启程任务·合成台', goals:['进入合成界面，合成任意3个物品'], last:3, rewards:[{key:'wood',text:'木材'},{key:'flax',text:'亚麻'}],
    hook:'qCraftAvail', auto:true, trackField:'qCraftDone' },
  { id:'qFruit',  cat:'side', name:'启程任务·果腹', goals:['累计使用果子回复生命值50次'], last:50, rewards:[{simple:'主角最大生命值+50'}],
    hook:'fruitFirstOwned', auto:true, trackField:'qFruitCount' },
  { id:'qMeat',   cat:'side', name:'启程任务·大口吃肉', goals:['累计使用熟肉回复生命值30次'], last:30, rewards:[{simple:'行动力上限+2'}],
    hook:'cookedMeatFirstOwned', auto:true, trackField:'qMeatCount' },
  { id:'qCar',    cat:'side', name:'启程任务·便捷出行', goals:['累计使用载具（徒步跋涉除外）6次'], last:6, rewards:[{key:'broom',text:'载具·魔法扫帚'}],
    hook:'nonWalkVehicleOwned', auto:true, trackField:'qCarCount' },
  { id:'qFriend', cat:'side', name:'启程任务·友谊的再开始', goals:['任意角色好感度达到10'], last:10, rewards:[{key:'amethyst',text:'紫水晶'}],
